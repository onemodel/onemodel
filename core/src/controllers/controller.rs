...
impl Controller {
    ...
    fn ask_and_save(
        ...
        let name_opt: Option<String> = self.ui.ask_for_string3(prompt, None, x4); //from claude:.as_deref());
    ...
    pub fn ask_for_name_and_write_entity(
        ...
        type_in: &str,
        existing_entity_in: Rc<RefCell<Option<&mut Entity>>>,       /*= None*/
        previous_name_in: Option<&str>,            /*None*/
    ...
    fn try_asking_and_saving<F>(
        ...
        error_msg_in: &str,
        ask_and_save_in: &F,
        default_name_in: Option<&str>, /*= None*/
        //%%%%%%%%
        type_in: &str,
        max_name_length: u16,
        example: &str,
    ...
    {
        let entity_class: Option<EntityClass> = match class_id_in {
            None => None,
    ...
    pub fn ask_for_and_write_class_and_template_entity_name(
        ...
        leading_text_in: Option<&str>,
        existing_entity_in: Rc<RefCell<Option<&mut Entity>>>,
        class_in: &Option<EntityClass>, /*= None*/
        type_in: &str,
        max_name_length: u16,
        example: &str,
        duplicate_name_probably_ok: bool,
        ...
        //%%%%%%%%
         ...
         -> Result<Option<i64>, anyhow::Error> {
            ...
            let name_opt = self
                .ui
                .ask_for_string3(prompts, None, default_name.unwrap_or(""));
            if name_opt.is_none() {
                return Ok(None);
            }
        ...
        let default_name: Option<&str> = match class_in {
            Some(mut c) => Some(c.get_name(None)?.as_str()),
            None => None,
        };

...
impl Controller {
                    ...
                    Some(mut entity) => {
                            ...
                            .expect("Unable to determine if entity.is_archived.")
                        {
                            ...
                            let ans = self.ui.ask_which(
                                Some(vec![&msg.as_str()]),
                                vec![
                                    "Un-archive the default entity now",
                                    "Display archived entities",
                                ],
                                vec![],
                                true,
                                None,
    ...
    */
    /*%%%%
        /// In any given usage, consider whether askForNameAndWriteEntity should be used instead:
        ...
        /// askForClassInfoAndNameAndCreateEntity (this one) prompts for a class and checks whether it
        /// should copy default attributes from the class-defining
        /// (template) entity.
        /// There is also editEntityName which calls askForNameAndWriteEntity: it checks if the Entity being
    ...
    */
    ...
    pub fn choose_or_create_object() {
        /*%%%%
           * db_in: Database, leading_text_in: Option[List[String]], previousSelectionDescIn: Option<String>,

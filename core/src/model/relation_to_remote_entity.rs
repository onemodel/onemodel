...
class RelationToRemoteEntity(db: Database, id: i64, rel_type_id: i64, mEntityId1: i64, mRemoteInstanceId: String,
  ...
  protected override fn read_data_from_db() {
    ...
    fn move_it(to_containing_entity_id_in: i64, sorting_index_in: i64) -> RelationToRemoteEntity {
  ...
  /** Removes this object from the system. */
    fn delete() {
    db.delete_relation_to_remote_entity(get_attr_type_id(), get_related_id1, mRemoteInstanceId, get_related_id2)
    }

  lazy private let mRemoteAddress = new OmInstance(db, getRemoteInstanceId).get_address;

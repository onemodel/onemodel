...
class RestDatabase(mRemoteAddress: String) extends Database {
  override fn getRemoteAddress -> Option[String] {
    Some(mRemoteAddress)
  }
  ...
  override fn getAttributeCount(entityIdIn: i64, includeArchivedEntitiesIn: Boolean = false) -> i64 {
  ...
  override fn getRelationToLocalEntityCount(entityIdIn: i64, includeArchivedEntitiesIn: Boolean) -> i64 {
  ...
  override fn relationToGroupKeyExists(idIn: i64) -> Boolean {
  ...
  override fn  relationTypeKeyExists(idIn: i64) -> Boolean {
    getBoolean("/relationTypes/" + idIn + "/exists")
  }

  override fn omInstanceKeyExists(idIn: String) -> Boolean {
    getBoolean("/omInstances/" + UriEncoding.encodePathSegment(idIn, "UTF-8") + "/exists")
  }

  override fn classKeyExists(idIn: i64) -> Boolean {
    getBoolean("/classes/" + idIn + "/exists")
  }

  override fn attributeKeyExists(formIdIn: i64, idIn: i64) -> Boolean {
    getBoolean("/attributes/" + formIdIn + "/" + idIn + "/exists")
  }

  override fn quantityAttributeKeyExists(idIn: i64) -> Boolean {
    getBoolean("/quantityAttributes/" + idIn + "/exists")
  }

  override fn dateAttributeKeyExists(idIn: i64) -> Boolean {
    getBoolean("/dateAttributes/" + idIn + "/exists")
  }

  override fn booleanAttributeKeyExists(idIn: i64) -> Boolean {
    getBoolean("/booleanAttributes/" + idIn + "/exists")
  }

  override fn fileAttributeKeyExists(idIn: i64) -> Boolean {
    getBoolean("/fileAttributes/" + idIn + "/exists")
  }

  override fn textAttributeKeyExists(idIn: i64) -> Boolean {
    getBoolean("/textAttributes/" + idIn + "/exists")
  }

  override fn relationToLocalEntityKeysExistAndMatch(idIn: i64, relationTypeIdIn: i64, entityId1In: i64, entityId2In: i64) -> Boolean {
  ...
  override fn  relationToRemoteEntityKeysExistAndMatch(idIn: i64, relationTypeIdIn: i64, entityId1In: i64, remoteInstanceIdIn: String, entityId2In: i64) -> Boolean {
  ...
  override  fn groupKeyExists(idIn: i64) -> Boolean {
  ...
  override fn includeArchivedEntities -> Boolean {
    getBoolean("/entities/includeArchived")
  }

  override fn getClassName(idIn: i64) -> Option[String] {
    getOptionString("/classes/" + idIn + "/name")
  }

  override fn  getEntityName(idIn: i64) -> Option[String] {
  ...
  override fn getClassData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/classes/" + idIn, Array(Database.GET_CLASS_DATA__RESULT_TYPES))
  }

  override fn  getRelationTypeData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/relationTypes/" + idIn, Array(Database.GET_RELATION_TYPE_DATA__RESULT_TYPES))
  }

  override fn getOmInstanceData(idIn: String) -> Array[Option[Any]] {
  ...
  override fn  getFileAttributeData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/fileAttributes/" + idIn, Array(Database.GET_FILE_ATTRIBUTE_DATA__RESULT_TYPES))
  }

  override fn  getTextAttributeData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/textAttributes/" + idIn, Array(Database.GET_TEXT_ATTRIBUTE_DATA__RESULT_TYPES))
  }

  override fn  getQuantityAttributeData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/quantityAttributes/" + idIn, Array(Database.GET_QUANTITY_ATTRIBUTE_DATA__RESULT_TYPES))
  }

  override fn  getRelationToGroupData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/relationsToGroup/" + idIn, Array(Database.GET_RELATION_TO_GROUP_DATA_BY_ID__RESULT_TYPES))
  }
  ...
  override fn  getGroupData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/groups/" + idIn, Array(Database.GET_GROUP_DATA__RESULT_TYPES))
  }

  override fn getDateAttributeData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/dateAttributes/" + idIn, Array(Database.GET_DATE_ATTRIBUTE_DATA__RESULT_TYPES))
  }

  override  fn getBooleanAttributeData(idIn: i64) -> Array[Option[Any]] {
    getArrayOptionAny("/booleanAttributes/" + idIn, Array(Database.GET_BOOLEAN_ATTRIBUTE_DATA__RESULT_TYPES))
  }
  ...
  override fn  getEntityData(idIn: i64) -> Array[Option[Any]] {
  ...
  override fn findAllEntityIdsByName(nameIn: String, caseSensitive: Boolean) -> java.util.ArrayList[i64] {
    let name = UriEncoding.encodePathSegment(nameIn, "UTF-8");
  ...
  override fn findRelationType(typeNameIn: String, expectedRows: Option[Int]) -> ArrayList[i64] {
  ...
  override fn beginTrans(): Unit = ???

  override fn rollbackTrans(): Unit = ???

  override fn commitTrans(): Unit = ???
  ...
  override fn  deleteDateAttribute(idIn: i64): Unit = ???
  ...
  override fn deleteQuantityAttribute(idIn: i64): Unit = ???
  ...
  override fn deleteFileAttribute(idIn: i64): Unit = ???

  override fn  updateFileAttribute(idIn: i64, parentIdIn: i64, attrTypeIdIn: i64, descriptionIn: String): Unit = ???

  override fn  updateFileAttribute(idIn: i64, parentIdIn: i64, attrTypeIdIn: i64, descriptionIn: String, originalFileDateIn: i64, storedDateIn: i64,
  ...
  override fn  updateGroup(groupIdIn: i64, nameIn: String, allowMixedClassesInGroupIn: Boolean, newEntriesStickToTopIn: Boolean): Unit = ???

  override fn setUserPreference_EntityId(nameIn: String, entityIdIn: i64): Unit = ???

  override fn deleteRelationType(idIn: i64): Unit = ???

  override fn  deleteGroupAndRelationsToIt(idIn: i64): Unit = ???

  override fn  deleteEntity(idIn: i64, callerManagesTransactionsIn: Boolean): Unit = ???
  ...
  override fn  updateRelationType(idIn: i64, nameIn: String, nameInReverseDirectionIn: String, directionalityIn: String): Unit = ???

  override  fn createClassAndItsTemplateEntity(classNameIn: String): (i64, i64) = ???

  override  fn createGroup(nameIn: String, allowMixedClassesInGroupIn: Boolean): i64 = ???

  override fn updateEntityOnlyName(idIn: i64, nameIn: String): Unit = ???

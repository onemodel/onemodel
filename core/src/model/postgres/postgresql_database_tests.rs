...
mod test {
    ...
    fn create_test_boolean_attribute_with_one_entity(
        ...
        let boolean_attribute_id: i64 = db
            ...
            .unwrap();
        let mut ba =
            BooleanAttribute::new2(db.clone(), transaction.clone(), boolean_attribute_id).unwrap();
    ...
    */
    ...
    fn escape_quotes_etc_allow_updating_db_with_single_quotes() {
        ...
        let entity_id: i64 = db
            .borrow()
            .create_entity(tx.clone(), name, None, None)
            .unwrap();
    ...
    fn test_entity_creation_and_update() {
        ...
        db.borrow()
            .update_entity_only_name(tx.clone(), id, new_name)
            .unwrap();
        // have to create new instance to re-read the data:
        let mut updated_entity = Entity::new2(db.clone(), tx.clone(), id).unwrap();
        let x = updated_entity.get_name(tx.clone()).unwrap();
        let name3 = x.as_str();
    ...
    fn get_attr_count_and_get_attribute_sorting_rows_count() {
        ...
        let initial_num_sorting_rows: u64 = db
            .borrow()
            .get_attribute_sorting_rows_count(None, Some(id))
            .unwrap();
        assert!(
            db.borrow()
                .get_attribute_count(tx.clone(), id, false)
                .unwrap()
                == 0
        );
        ...
        assert!(
            db.clone()
                .borrow()
                .get_attribute_sorting_rows_count(tx.clone(), Some(id))
                .unwrap()
                == 2
        );
    ...
    fn create_and_add_test_relation_to_group_on_to_entity(
        ...
        let mut rtg = RelationToGroup::new3(db_in, transaction.clone(), rtg_id)?;
    ...
    fn quantity_create_update_delete_methods() {
        ...
        let initial_total_sorting_rows_count = db
            ...
            .unwrap();
        let quantity_attribute_id: i64 = create_test_quantity_attribute_with_two_entities(
            db.clone(),
            tx.clone(),
            entity_id,
            None,
        ...
        let mut qa =
            QuantityAttribute::new2(db.clone(), tx.clone(), quantity_attribute_id).unwrap();
        let (pid1, atid1, uid1) = (
        ...
        assert_eq!(
            db.borrow()
                .get_attribute_sorting_rows_count(tx.clone(), Some(entity_id))
                .unwrap(),
            1
        );

        // Delete the quantity attribute and check correctness
        let entity_count_before_quantity_deletion: u64 =
            db.borrow().get_entity_count(tx.clone()).unwrap();
        db.borrow()
            .delete_quantity_attribute(tx.clone(), quantity_attribute_id)
            .unwrap();
        ...
        let entity_count_after_quantity_deletion: u64 =
            db.borrow().get_entity_count(tx.clone()).unwrap();
        assert_eq!(
            db.borrow()
                .get_quantity_attribute_count(tx.clone(), entity_id)
    ...
    fn attribute_and_attribute_sorting_row_deletion_both_happen_automatically_upon_entity_deletion()
    {
        ...
        let entity_id = db
            ...
            .create_entity(
                None,
                "test: org.onemodel.PSQLDbTest sorting rows stuff",
                None,
                None,
            )
            .unwrap();
        ...
        assert_eq!(
            db.borrow()
                .get_attribute_sorting_rows_count(None, Some(entity_id))
                .unwrap(),
            1
        );
        assert_eq!(
            db.borrow()
                .get_quantity_attribute_count(None, entity_id)
                .unwrap(),
            1
        );
    ...
    fn text_attribute_create_delete_update_methods() {
        ...
        let entity_id = db
            ...
            .create_entity(
                tx.clone(),
                "test: org.onemodel.PSQLDbTest.testTextAttrs",
                None,
                None,
            )
            .unwrap();
        ...
        assert_eq!(
            db.borrow()
                .get_text_attribute_count(tx.clone(), entity_id)
                .unwrap(),
            1
        );

        let entity_count_before_text_deletion: u64 =
            db.borrow().get_entity_count(tx.clone()).unwrap();
        db.borrow()
            .delete_text_attribute(tx.clone(), text_attribute_id)
            .unwrap();
        assert_eq!(
            db.borrow()
                .get_text_attribute_count(tx.clone(), entity_id)
        ...
        let entity_count_after_text_deletion: u64 =
            db.borrow().get_entity_count(tx.clone()).unwrap();
        ...
        db.clone()
            .borrow()
            .delete_entity(tx.clone(), entity_id)
            .unwrap();
        if db
            .borrow()
            .get_text_attribute_count(tx.clone(), entity_id)
        ...
        {
            panic!(
                "Deleting the model entity should also have deleted its text \
    ...
    fn date_attribute_create_delete_update_methods() {
        ...
        let (pid1, atid1) = (
            da.get_parent_id(None).unwrap(),
            da.get_attr_type_id(None).unwrap(),
        );
        assert_eq!(entity_id, pid1);

        let date = Utc::now().timestamp_millis();
        db.borrow()
            .update_date_attribute(None, date_attribute_id, pid1, date, atid1)
            .unwrap();
        ...
        assert_eq!(
            db.clone()
                .borrow()
                .get_date_attribute_count(None, entity_id)
                .unwrap(),
            1
        );
        ...
        db.borrow()
            .delete_date_attribute(None, date_attribute_id)
            .unwrap();
        assert_eq!(
            db.borrow()
                .get_date_attribute_count(None, entity_id)
        ...
        assert_eq!(
            db.borrow().get_entity_count(None).unwrap(),
            entity_count_before_date_deletion
        );
    ...
    fn boolean_create_delete_update_methods() {
        ...
        assert!(
            db.borrow()
                .get_boolean_attribute_count(tx.clone(), entity_id)
                .unwrap()
                == 1
        );

        let entity_count_before_attr_deletion: u64 =
            db.borrow().get_entity_count(tx.clone()).unwrap();
        db.borrow()
            .delete_boolean_attribute(tx.clone(), boolean_attribute_id)
            .unwrap();
        assert!(
            db.borrow()
                .get_boolean_attribute_count(tx.clone(), entity_id)
        ...
        let entity_count_after_attr_deletion: u64 =
            db.borrow().get_entity_count(tx.clone()).unwrap();
    ...
    */
    ...
    fn relation_to_entity_methods_and_relation_type_methods() {
        ...
        let starting_entity_only_count = db
            .borrow()
            .get_entities_only_count(tx.clone(), false, None, None)
            .unwrap();
        ...
        let entity_id = db
            ...
            .create_entity(
                tx.clone(),
                "test: org.onemodel.PSQLDbTest.testRelsNRelTypes()",
                None,
                None,
            )
            .unwrap();
        let starting_rel_count = db
            .borrow()
            .get_relation_types(db.clone(), tx.clone(), 0, Some(25))
            .unwrap()
            .len();
        let rel_type_id: i64 = db
            .borrow()
        ...
        assert_eq!(
            db.borrow()
                ...
                .unwrap()
                .len(),
            starting_rel_count + 1
        );
        assert_eq!(
            db.borrow()
                .get_entities_only_count(tx.clone(), false, None, None)
                .unwrap(),
            starting_entity_only_count + 1
        );
        ...
        let check_relation = db
            .borrow()
            .get_relation_to_local_entity_data(
                tx.clone(),
                rel_type_id,
                entity_id,
                related_entity_id,
        ...
        assert_eq!(
            db.borrow()
                .get_relation_to_local_entity_count(tx.clone(), entity_id, true)
                .unwrap(),
            1
        );
        ...
        // Have to create new instance to re-read the data:
        let mut updated_relation_type =
            RelationType::new2(db.clone(), tx.clone(), rel_type_id).unwrap();
        assert_eq!(
            updated_relation_type.get_name(tx.clone()).unwrap(),
            new_name
        );
        assert_eq!(
            updated_relation_type
                .get_name_in_reverse_direction(tx.clone())
                .unwrap(),
            name_in_reverse
        );
        assert_eq!(
            updated_relation_type
                .get_directionality(tx.clone())
                .unwrap(),
            RelationType::BIDIRECTIONAL
        );

        db.borrow()
            .delete_relation_to_local_entity(tx.clone(), rel_type_id, entity_id, related_entity_id)
            .unwrap();
        assert_eq!(
            db.borrow()
                .get_relation_to_local_entity_count(tx.clone(), entity_id, true)
        ...
        let entity_only_count_before_relation_type_deletion: u64 = db
            .borrow()
            .get_entities_only_count(tx.clone(), false, None, None)
            .unwrap();
        db.borrow()
            .delete_relation_type(tx.clone(), rel_type_id)
            .unwrap();
        assert_eq!(
            db.borrow().get_relation_type_count(tx.clone()).unwrap(),
            starting_relation_type_count
        );
        ...
        assert_eq!(
            entity_only_count_before_relation_type_deletion,
            db.borrow()
                .get_entities_only_count(tx.clone(), false, None, None)
                .unwrap()
        );
    ...
    fn get_containing_groups_ids_finds_groups_containing_the_test_group() {
        ...
        group1
            .add_entity(None /*tx.clone()*/, entity_id2, None)
            .unwrap();
        ...
        let containing_groups: Vec<Vec<Option<DataType>>> = db
            .borrow()
            .get_groups_containing_entitys_groups_ids(
                None, /*tx.clone()*/
                group2.get_id(),
                Some(5),
            )
        ...
        let containing_groups2: Vec<Vec<Option<DataType>>> = db
            .borrow()
            .get_groups_containing_entitys_groups_ids(
                None, /*tx.clone()*/
                group2.get_id(),
    ...
    fn relation_to_group_and_group_methods() -> Result<(), Box<dyn std::error::Error>> {
        Util::initialize_tracing();
        let db: Rc<RefCell<PostgreSQLDatabase>> =
            Rc::new(RefCell::new(Util::initialize_test_db()?));
        ...
        let entity_id =
            db.clone()
                .borrow()
                .create_entity(None, entity_name.as_str(), None, None)?;
        ...
        let rel_type_id = db.clone().borrow().create_relation_type(
            None,
            "contains",
            "",
            RelationType::UNIDIRECTIONAL,
        ...
        let mut rtg = RelationToGroup::new2(
            db.clone(),
            tx.clone(),
            created_rtg_id,
            entity_id,
        ...
        let check_relation = db
            .borrow()
            .get_relation_to_group_data_by_keys(
                tx.clone(),
                rtg.get_parent_id(tx.clone()).unwrap(),
                rtg.get_attr_type_id(tx.clone()).unwrap(),
                rtg.get_group_id(tx.clone()).unwrap(),
            )
            .unwrap();
        ...
        let check_again = db
            .borrow()
            .get_relation_to_group_data(tx.clone(), rtg.get_id())?;
        ...
        let entity_id2 = db
            .borrow()
            .create_entity(tx.clone(), format!("{}2", entity_name).as_str(), None, None)
            .unwrap();
        ...
        let result = RelationToGroup::new2(
            db.clone(),
            tx.clone(),
            rtg.get_id(),
            rtg.get_parent_id(tx.clone()).unwrap(),
        ...
        let entity_id3 = db
            .borrow()
            .create_entity(tx.clone(), format!("{}3", entity_name).as_str(), None, None)
            .unwrap();
        ...
        let entity_id4 = db
            .clone()
            .borrow()
            .create_entity(tx.clone(), format!("{}4", entity_name).as_str(), None, None)
            .unwrap();
        group2.add_entity(tx.clone(), entity_id4, None).unwrap();

        let entity_id5 = db
            .borrow()
            .create_entity(tx.clone(), format!("{}5", entity_name).as_str(), None, None)
            .unwrap();
        group2.add_entity(tx.clone(), entity_id5, None).unwrap();

        db.borrow()
            .get_group_entry_sorting_index(tx.clone(), group_id2, entity_id5)
            .unwrap();

        assert_eq!(group2.get_size(tx.clone(), 3).unwrap(), 3);
        assert_eq!(
            db.borrow()
                .get_group_entry_ids(tx.clone(), group2.get_id(), 0, None)
                .unwrap()
                .len(),
            3
        );
        ...
        assert_eq!(
            db.borrow()
                .get_relation_to_group_count(tx.clone(), entity_id)?,
            0
        );
    ...
    fn get_groups_works() {
        ...
        let group3id = db
            .borrow()
            .create_group(None /*tx.clone()*/, "g3", false)
            .unwrap();
        let number = db
            .borrow()
            .get_groups(db.clone(), None /*tx.clone()*/, 0, None, None)
            .unwrap()
            .len();
        let number2 = db
            .borrow()
        ...
        let number3 = db
            .borrow()
            .get_groups(db.clone(), None /*tx.clone()*/, 1, None, None)
            .unwrap()
            .len();
    ...
    fn deleting_entity_works_even_if_entity_is_in_a_relationtogroup() {
        ...
        let starting_entity_count = db
            .borrow()
            .get_entities_only_count(None, false, None, None)
            .unwrap();
        ...
        let entity_id1 = db
            .borrow()
            .create_entity(None, &format!("{}{}", entity_name, 1), None, None)
            .unwrap();
        ...
        let entity_id2 = db
            .borrow()
            .create_entity(None, &format!("{}{}", entity_name, 2), None, None)
            .unwrap();
        assert_eq!(
            db.borrow()
                .get_entities_only_count(None, false, None, None)
                .unwrap(),
            starting_entity_count + 3
        );
        assert_eq!(
            db.borrow()
                .get_count_of_groups_containing_entity(None, entity_id2)
                .unwrap(),
            0
        );
        group.add_entity(None, entity_id2, None).unwrap();
        ...
        let descriptions = db
            .borrow()
            .get_containing_relation_to_group_descriptions(None, entity_id2, Some(9999))
            .unwrap();
        assert_eq!(descriptions.len(), 1);
        assert_eq!(
            descriptions[0],
            format!("{}->{}", entity_name, rel_to_group_name)
        );
        // Doesn't get an error
        db.borrow().delete_entity(None, entity_id2).unwrap();

        let descriptions2 = db
            .borrow()
            .get_containing_relation_to_group_descriptions(None, entity_id2, Some(9999))
            .unwrap();
        ...
        let list = db
            .borrow()
            .get_group_entry_ids(None, group_id, 0, None)
            .unwrap();
    ...
    fn get_sorted_attributes_returns_them_all_and_correctly() {
        ...
        db.borrow()
            .update_entity_only_public_status(None, related_entity_id, None)
            .unwrap();
        let (_, only_public_total_attrs_available1) = db
            .borrow()
            .get_sorted_attributes(db.clone(), None, entity_id, 0, 999, true)
            .unwrap();
        db.borrow()
            .update_entity_only_public_status(None, related_entity_id, Some(false))
            .unwrap();
        let (_, only_public_total_attrs_available2) = db
            .borrow()
            .get_sorted_attributes(db.clone(), None, entity_id, 0, 999, true)
            .unwrap();
        db.borrow()
            .update_entity_only_public_status(None, related_entity_id, Some(true))
            .unwrap();
        let (_, only_public_total_attrs_available3) = db
            .borrow()
            .get_sorted_attributes(db.clone(), None, entity_id, 0, 999, true)
            .unwrap();
        assert_eq!(
            only_public_total_attrs_available1,
            only_public_total_attrs_available2
        );
        assert_eq!(
            (only_public_total_attrs_available3 - 1),
            only_public_total_attrs_available2
        );

        let (attr_tuples, total_attrs_available) = db
            .borrow()
            .get_sorted_attributes(db.clone(), None, entity_id, 0, 999, false)
            .unwrap();
        ...
        for (_, attr) in attr_tuples {
            ...
            else if db.borrow().get_attribute_form_name(form_id).unwrap()
    ...
    fn get_type_info(attr: Box<dyn Any>) -> Result<i32, anyhow::Error> {
        ...
        match attr.downcast_ref::<Rc<dyn Attribute>>() {
            ...
            None => {
                ...
                return Err(anyhow!(
                    "Unable to determine form_id for attribute(?) {:?}",
                    attr
                ));
            }
        }
    ...
    fn om_instance_read_data_from_db() {
        ...
        let entity_id = db
            ...
            .create_entity(
                trans.clone(),
                "test: om_instance_read_data_from_db",
                None,
                None,
            )
            .unwrap();
        let uuid = uuid::Uuid::new_v4();
        let omi = OmInstance::create(
            db.clone(),
            trans.clone(),
    ...
    fn entity_deletion_should_also_delete_relation_to_local_entity_attributes() {
        ...
        let rel_type_id = db
            ...
            .unwrap();
        let starting_local_count = db
            .borrow()
            .get_relation_to_local_entity_count(trans.clone(), entity_id, true)
            .unwrap();
        let starting_remote_count = db
            .borrow()
            .get_relation_to_remote_entity_count(trans.clone(), entity_id)
            .unwrap();
        let related_entity_id = create_test_relation_to_local_entity_with_one_entity(
            db.clone(),
            trans.clone(),
            entity_id,
            rel_type_id,
        ...
        let oi_info = db
            .borrow()
            .get_local_om_instance_data(trans.clone())
            .unwrap();
        let oi_id: String = oi_info.0;
        let remote_entity_id = 1234;
        db.borrow()
            .create_relation_to_remote_entity(
                trans.clone(),
                rel_type_id,
                entity_id,
                remote_entity_id,
        ...
        assert!(!db
            .borrow()
            .get_relation_to_remote_entity_data(
                trans.clone(),
                rel_type_id,
                entity_id,
                oi_id.clone(),
        ...
        let local_entity_result = db.borrow().get_relation_to_local_entity_data(
            trans.clone(),
            rel_type_id,
            entity_id,
            related_entity_id,
        ...
        let remote_entity_result = db.borrow().get_relation_to_remote_entity_data(
            trans.clone(),
            rel_type_id,
            entity_id,
            oi_id.clone(),
        ...
        assert!(remote_entity_result
            ...
            .contains("Got 0 instead of 1 result"));
        db.borrow()
            .delete_relation_type(trans.clone(), rel_type_id)
            .unwrap();
    }
    ...
    fn attributes_handle_valid_on_dates_properly_in_and_out_of_db() {
        ...
        let entity_id = db
            ...
            .create_entity(
                tx.clone(),
                "test: org.onemodel.PSQLDbTest.attributes...",
                None,
                None,
            )
            .unwrap();
        ...
        create_test_quantity_attribute_with_two_entities(
            db.clone(),
            tx.clone(),
            entity_id,
            Some(0),
    ...
    fn test_add_quantity_attribute_with_bad_parent_id_does_not_work() {
        ...
        let bad_parent_id: i64 = db
            .borrow()
            .find_id_which_is_not_key_of_any_entity(None)
            .unwrap();
        // idea: make it a more specific failure type, so we catch only the error we want...?
        let _quantity_id =
            create_test_quantity_attribute_with_two_entities(db.clone(), None, bad_parent_id, None);
    }
    ...
    */
    ...
    fn test_create_base_data_etc() {
        ...
        let group_id_of_class_templates = db
            .borrow()
        ...
        let mut group =
            Group::new2(db.clone(), None, group_id_of_class_templates.unwrap()).unwrap();
        assert!(group.get_mixed_classes_allowed(None).unwrap());

        let person_template_entity_id: i64 = db
            .borrow()
            .find_entity_only_ids_by_name(None, person_template.clone())
            .unwrap()[0];
        ...
        let mut found = false;
        let entity_ids_in_group: Vec<i64> = db
            .borrow()
            .get_group_entry_ids(None, group_id_of_class_templates.unwrap(), 0, None)
            .unwrap();
        ...
        db.borrow()
            .find_contained_local_entity_ids(
                None,
                &mut found_ids,
                system_entity_id,
    ...
    fn test_is_duplicate_entity() {
        ...
        let entity_id: i64 = db.create_entity(None, &name, None, None).unwrap();
        assert!(db.is_duplicate_entity_name(None, &name, None).unwrap());
        assert!(!db
            .is_duplicate_entity_name(None, &name, Some(entity_id))
            .unwrap());
        ...
        let entity_id_with_lowercase_name: i64 = db
            ...
            .unwrap();
        assert!(db
            .is_duplicate_entity_name(None, &name, Some(entity_id_with_lowercase_name))
            .unwrap());

        db.update_entity_only_name(None, entity_id, &name.to_lowercase())
            .unwrap();
        assert!(db
            .is_duplicate_entity_name(None, &name, Some(entity_id_with_lowercase_name))
            .unwrap());
        ...
        db.delete_entity(None, entity_id_with_lowercase_name)
            .unwrap();
        assert!(!db
            .is_duplicate_entity_name(None, &name, Some(entity_id))
            .unwrap());
        ...
        let rel_type_id: i64 = db
            ...
            .unwrap();
        assert!(db
            .is_duplicate_entity_name(None, &rel_type_name, None)
            .unwrap());
        assert!(!db
            .is_duplicate_entity_name(None, &rel_type_name, Some(rel_type_id))
            .unwrap());
    ...
    fn is_duplicate_entity_class_and_class_update_deletion_works() {
        ...
        db.borrow()
            .update_class_name(None, class_id, name.to_lowercase())
            .unwrap();
        assert!(!EntityClass::is_duplicate(db.clone(), None, &name, Some(class_id)).unwrap());
        assert!(EntityClass::is_duplicate(db.clone(), None, &name.to_lowercase(), None).unwrap());
        assert!(
            !EntityClass::is_duplicate(db.clone(), None, &name.to_lowercase(), Some(class_id))
                .unwrap()
        );

        db.borrow()
            .update_class_name(None, class_id, name.clone())
            .unwrap();
        db.borrow()
            .update_class_create_default_attributes(None, class_id, Some(false))
            .unwrap();
        ...
        db.borrow()
            .update_class_create_default_attributes(None, class_id, None)
            .unwrap();
        let mut entity_class = EntityClass::new2(db.clone(), None, class_id).unwrap();
        ...
        db.borrow()
            .update_class_create_default_attributes(None, class_id, Some(true))
            .unwrap();
        let mut entity_class = EntityClass::new2(db.clone(), None, class_id).unwrap();
        ...
        db.borrow()
            .update_entitys_class(None, entity_id, None)
            .unwrap();
        db.borrow()
            .delete_class_and_its_template_entity(class_id)
            .unwrap();
        assert!(!EntityClass::is_duplicate(db.clone(), None, &name, Some(class_id)).unwrap());
        assert!(!EntityClass::is_duplicate(db.clone(), None, &name, None).unwrap());
    }
    ...
    fn entities_in_a_group_and_getclasses_classcount_methods_work() {
        ...
        let (class_id2, entity_id2) = db
            .borrow()
            .create_class_and_its_template_entity(None, &format!("{}{}", entity_name, 2))
            .unwrap();
        ...
        assert!(!db
            .borrow()
            .is_entity_in_group(None, group_id, entity_id)
            .unwrap());
        ...
        assert!(!db
            .borrow()
            .is_entity_in_group(None, group_id, entity_id2)
            .unwrap());
        ...
        db.borrow()
            .update_entitys_class(None, entity_id2, Some(class_id))
            .unwrap();
        group.add_entity(None, entity_id2, None).unwrap();
        // ...and for convenience while here, make sure we can't make mixed classes with changing the *entity* either:
        let result = db
            .borrow()
            .update_entitys_class(None, entity_id2, Some(class_id2));
        assert!(result.is_err());
        let error_message = format!("{}", result.err().unwrap());
        assert!(error_message.contains(Util::MIXED_CLASSES_EXCEPTION));
        ...
        assert!(!db
            .borrow()
            .are_mixed_classes_allowed(None, &group_id)
            .unwrap());
        ...
        assert!(db
            .borrow()
            .are_mixed_classes_allowed(None, &class_group_id.unwrap())
            .unwrap());
        ...
        assert_eq!(
            db.borrow().get_group_size(None, group_id, 1).unwrap(),
            group_size_before_removal
        );
        assert_eq!(
            db.borrow().get_group_size(None, group_id, 3).unwrap(),
            group_size_before_removal
        );
        ...
        db.borrow()
            .remove_entity_from_group(None, group_id, entity_id2)
            .unwrap();
    ...
    fn get_entities_only_and_its_count_method() {
        ...
        let starting_entity_count = db
            ...
            .get_entities_only_count(None, false, None, None)
            .unwrap();
        let row: Vec<Option<DataType>> = db
            .borrow()
            .db_query_wrapper_for_one_row(None, "select id from class limit 1", "i64")
            .unwrap();
        ...
        let num_entities_in_class = db
            .borrow()
            .extract_row_count_from_count_query(
                None,
                &format!(
                    "select count(1) from entity where class_id={}",
                    some_class_id
                ),
            )
            .unwrap();
        ...
        let all_entities_in_class = db
            ...
            .unwrap();
        let all_entities_in_class_count1 = db
            .borrow()
            .get_entities_only_count(None, true, Some(some_class_id), None)
            .unwrap();
        let all_entities_in_class_count2 = db
            .borrow()
            .get_entities_only_count(None, true, Some(some_class_id), None)
            .unwrap();
        assert_eq!(all_entities_in_class_count1, all_entities_in_class_count2);

        let template_class_id: i64 = EntityClass::new2(db.clone(), None, some_class_id)
            .unwrap()
            .get_template_entity_id(None)
            .unwrap();
        let all_entities_in_class_count_wo_class = db
            .borrow()
            .get_entities_only_count(None, true, Some(some_class_id), Some(template_class_id))
            .unwrap();
        assert_eq!(
            all_entities_in_class_count_wo_class,
            all_entities_in_class_count1 - 1
        );
        assert_eq!(
            all_entities_in_class.len(),
            all_entities_in_class_count1 as usize
        );
        assert!(
            all_entities_in_class.len()
                < db.borrow()
        ...
        let id1: i64 = db
            .borrow()
            .create_entity(None, "name1", None, None)
            .unwrap();
        let entity1 = Entity::new2(db.clone(), None, id1).unwrap();
        let (group_id, rtg_id) = entity1
            ...
            .unwrap();
        let mut rtg =
            RelationToGroup::new2(db.clone(), None, rtg_id, id1, rel_type_id, group_id).unwrap();
        assert!(db
            .borrow()
            .relation_to_group_keys_exist(
                None,
                rtg.get_parent_id(None).unwrap(),
                rtg.get_attr_type_id(None).unwrap(),
                rtg.get_group_id(None).unwrap()
            )
            .unwrap());
        assert!(db
            .borrow()
            .attribute_key_exists(None, rtg.get_form_id().unwrap(), rtg.get_id())
            .unwrap());

        let id2: i64 = db
            .borrow()
            .create_entity(None, "name2", None, None)
            .unwrap();
        let group: Group = Group::new2(db.clone(), None, group_id).unwrap();
        group.add_entity(None, id2, None).unwrap();
        let entity_count_after_creating = db
            .borrow()
            .get_entities_only_count(None, false, None, None)
            .unwrap();
        ...
        let result_size = db
            .borrow()
            .get_entities_only(db.clone(), None, 0, None, None, false, None, None)
            .unwrap()
            .len();
        assert_eq!(entity_count_after_creating as usize, result_size);

        let result_size_with_none_parameter = db
            .borrow()
            .get_entities_only(db.clone(), None, 0, None, None, false, None, None)
            .unwrap()
            .len();
        assert_eq!(
            entity_count_after_creating as usize,
            result_size_with_none_parameter
        );
        // the real part 2 test (or prev line?)
        let result_size_with_group_omission = db
            .borrow()
            .get_entities_only(
                db.clone(),
                None,
            ...
            .len();
        assert_eq!(
            entity_count_after_creating as usize - 1,
            result_size_with_group_omission
        );
    }
    ...
    fn entities_in_a_group_table_should_allow_all_a_groups_entities_to_have_no_class() {
        ...
        let entity_id4 = db
            .borrow()
            .create_entity(None, &format!("{}{}", entity_name, 4), None, None)
            .unwrap();
        // ...so it works to add another one that's NULL
        ...
        let entity_id5 = db
            .borrow()
            .create_entity(None, &format!("{}{}", entity_name, 5), Some(class_id), None)
            .unwrap();
    ...
    fn test_get_entities_only_count() {
        ...
        let entity_id = db
            ...
            .create_entity(
                None,
                "test: org.onemodel.PSQLDbTest.get_entities_only_count",
                None,
                None,
            )
            .unwrap();
        ...
        let rel_type_id2: i64 = db
            .borrow()
            .create_relation_type(None, "contains2", "", RelationType::UNIDIRECTIONAL)
            .unwrap();
        let entity = Entity::new2(db.clone(), None, entity_id).unwrap();
        create_and_add_test_relation_to_group_on_to_entity(
            db.clone(),
        ...
        let date_attribute_type_entities: Vec<Entity> = db
            .borrow()
    ...
    fn get_matching_entities_and_groups_should_work() {
        ...
        let entity_id1 = db
            ...
            .create_entity(
                None,
                "test: org.onemodel.PSQLDbTest.get_matching_entities1--abc",
                None,
                None,
            )
            .unwrap();
        ...
        let entity_id2 = db
            ...
            .create_entity(
                None,
                "test: org.onemodel.PSQLDbTest.get_matching_entities2",
                None,
                None,
            )
            .unwrap();
        db.borrow()
            .create_text_attribute(None, entity_id1, entity_id2, "defg", None, 0, None)
            .unwrap();

        let entities1 = db
            .borrow()
            .get_matching_entities(db.clone(), None, 0, None, None, "abc".to_string())
            .unwrap();
        assert_eq!(entities1.len(), 1);

        db.borrow()
            .create_text_attribute(None, entity_id2, entity_id1, "abc", None, 0, None)
            .unwrap();
        let entities2 = db
            .borrow()
            .get_matching_entities(db.clone(), None, 0, None, None, "abc".to_string())
        ...
        entity1
            .add_group_and_relation_to_group(None, rel_type_id, group_name, false, None, 1234, None)
            .unwrap();
        ...
        let empty_results = db
            ...
            .get_matching_groups(
                ...
                None,
                None,
                "some-xyz-not a grp name".to_string(),
            )
            .unwrap();
        ...
        let results = db
            .borrow()
            .get_matching_groups(db.clone(), None, 0, None, None, group_name.to_string())
            .unwrap();
    ...
    fn get_journal_should_show_activity_during_a_date_range() {
        ...
        let start_data_setup_time = SystemTime::now()
            .duration_since(UNIX_EPOCH)
            .unwrap()
            .as_millis() as i64;
        let entity_id: i64 = db
            .borrow()
            .create_entity(None, "test object", None, None)
            .unwrap();
    ...
    fn get_text_attribute_by_name_for_entity() {
        ...
        let result = db
            .borrow()
            .get_text_attribute_by_type_id(None, system_entity_id, 1, Some(1));
        assert!(result.is_err());
    }
    ...
    fn get_relations_to_group_containing_this_group_and_get_containing_relations_to_group() {
        ...
        let rtg_data = db
            .borrow()
            .get_relations_to_group_containing_this_group(None, group_id, 0, None)
            .unwrap();
        ...
        let same_rtgs = db
            .borrow()
            .get_containing_relations_to_group(None, entity_id2, 0, None)
            .unwrap();
